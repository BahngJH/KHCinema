...
public class FoodListCheck extends JPanel {
   ...
   public FoodListCheck(JPanel startPanel, JFrame mainF) {
      ...
      String imgPathPaymentSum = "Images/hand.png";
      ImageIcon originIconpaymentSum = new ImageIcon(imgPathPaymentSum);
      Image originImgPaymentSum = originIconpaymentSum.getImage();
      Image changedImgPaymentSum = originImgPaymentSum.getScaledInstance(80, 80, Image.SCALE_SMOOTH);
      ImageIcon IconSum = new ImageIcon(changedImgPaymentSum);
      JLabel imgSum = new JLabel(IconSum);
      imgSum.setSize(113, 81);
      imgSum.setLocation(614, 84);
      add(imgSum);
